...
public class FractThread extends Thread {
	...
	public FractThread(double x1, double x2, double y1, double y2, double gap, double imageX, double imageY,
			double real, double imaginary, BufferedImage img, int col, int nbrPotions, int threadID) {
		this.x1 = x1;
		this.x2 = x2;
		this.y1 = y1;
		this.y2 = y2;
